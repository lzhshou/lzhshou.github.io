...
5. **Lai, Z.**, Xia, Y., & Chen, Q. (2023). Discrete element modeling of granular hopper flow of irregular-shaped deformable particles. *Advanced Powder Technology*, 34(9), 104106. [DOI](https://doi.org/10.1016/j.apt.2023.104106) | [PDF](/pdf/first-or-correspondence/lai2023-discrete-element-modeling-of-granular-hopper-flow-of-irregular.pdf)
