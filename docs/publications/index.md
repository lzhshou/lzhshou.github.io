...
1. 吴峰, 黄林冲, & **赖正首**. (2022). 基于球面沃罗诺伊的颗粒表面离散与重构方法. *工程力学*, 40, 1-13. [链接](https://kns.cnki.net/kcms/detail/11.2595.O3.20221119.1654.014.html) | [PDF](pdf/first_or_correspondance/吴2022%20基于球面沃罗诺伊的颗粒表面离散与重构方法.pdf)
...
4. Huang, S., Huang, L., & **Lai, Z.** (2021). An extension of the Fourier series-based particle model to the GJK-based contact detection and resolution framework for DEM. *Computational Particle Mechanics*, 1-11. [DOI](https://doi.org/10.1007/s40571-021-00446-6) | [PDF](pdf/first_or_correspondance/Huang2021%20An%20extension%20of%20the%20Fourier%20series-based%20particle%20model%20to%20the%20GJK-based.pdf)

5. **Lai, Z.** & Huang, L. (2021). A polybezier-based particle model for the DEM modeling of granular media. *Computers and Geotechnics*, 134, 104052. [DOI](https://doi.org/10.1016/j.compgeo.2021.104052) | [PDF](pdf/first_or_correspondance/Lai2021%20A%20polybézier-based%20particle%20model%20for%20the%20DEM%20modeling%20of%20granular%20media.pdf)

6. **Lai, Z.**, Chen, Q., & Huang, L. (2021). A semianalytical Hertzian frictional contact model in 2D. *Applied Mathematical Modelling*, 92, 546-564. [DOI](https://doi.org/10.1016/j.apm.2020.11.016) | [PDF](pdf/first_or_correspondance/Lai2021%20A%20semianalytical%20Hertzian%20frictional%20contact%20model%20in%202D.pdf)
...
2. Xia, Y., **Lai, Z.**, Westover, T., Klinger, J., Huang, H., & Chen, Q. (2019). Discrete element modeling of deformable pinewood chips in cyclic loading test. *Powder Technology*, 345, 1--14. [DOI](https://doi.org/10.1016/j.powtec.2018.12.072) | [PDF](pdf/coauthored/Gleaton2019%20Microalga-induced%20biocementation%20of%20martian%20regolith%20simulant%20-%20Effects%20of.pdf)
