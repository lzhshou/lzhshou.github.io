...
**科学与技术问题**：针对含相变与破碎过程的气-液-固三相体系，如何发展跨尺度耦合算法以统一刻画颗粒-流体相互作用及流动失稳机理？
...
5. **Lai, Z.**, Xia, Y., & Chen, Q. (2023). Discrete element modeling of granular hopper flow of irregular-shaped deformable particles. *Advanced Powder Technology*, 34(9), 104106. [DOI](https://doi.org/10.1016/j.apt.2023.104106) | [PDF](pathname:///pdf/first-or-correspondence/lai2023-discrete-element-modeling-of-granular-hopper-flow-of-irregular.pdf)
